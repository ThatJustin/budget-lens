...
@LargeTest
class BudgetSpendingTrendsPageActivityInstrumentedTests{
    ...
    // from the opening MainActivity logo splash page and logging in into the app to viewing the budget page, then viewing the spending trends page.
    @Before
    fun setup() {
        clearStorage()
        ...
        onView(withId(R.id.constraintLayout3)).perform(click())
    }
